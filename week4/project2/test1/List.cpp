...
List::List()
{
	...
	ptr_item_array = new Item[4];
	ptr_item_array_swapper = new Item[4];
...
void List::add_item_to_list()
{
	...
	//inputs and validation for new Item objects. 
