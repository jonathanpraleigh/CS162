...
//quitting if the user chooses to exit immediately. Otherwise, program runs.
...
//input and validation for the dimensions.

	Board langton_board(dimensions);

//creation of the board object.
...
//input and validation of row, column, and orientation
...
//input and validation of turns.

//below is where the "game" is "played" Basically gets for the ant, get for square color
//and then set for new orientation and location based on what pulled from our gets.    
...
//once the simulation ends, the board is diplayed, memory cleared, and program terminated. 
